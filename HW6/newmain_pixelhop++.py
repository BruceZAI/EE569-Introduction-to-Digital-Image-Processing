...
parser.add_argument('--th2',default=0.001,type=float)
...
if __name__ == "__main__":
    ...
    # TODO: fill in this part
    p2 = Pixelhop(depth=3,TH1=args.th1,TH2=args.th2,SaabArgs=SaabArgs,shrinkArgs = shrinkArgs,concatArg=concatArg)
    ...
    with open('record.txt', 'a') as f:
        f.write("\npixelhop++ dataset: {};TH1: {}; TH2: {};---\n".format(args.data_set,args.th1, args.th2))
